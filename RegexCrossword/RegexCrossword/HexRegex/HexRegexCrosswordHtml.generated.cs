...
WriteLiteral("\":\"");
            ...
            #line 97 "..\..\HexRegex\HexRegexCrosswordHtml.cshtml"
                                                         Write(Model.Clues[axis - 'X',idx + 6].ToString().Replace("\\","\\\\"));
...
"        // {\"InspectedAxis\":\"X\",\"InspectedIdx\":-6,\"NewRowValue\":\".......\",\"Chang" +
"ed\":false}\r\n                var clue = cluesByAxisIdx[step.InspectedAxis][step.I" +
"nspectedIdx];\r\n                clue.addClass(\'current\');\r\n                if (st" +
"ep.Changed) clue.addClass(\'changed\');\r\n\r\n                var cells = step.NewRow" +
"Value.match(/\\.|\\[[^\\]]*\\]|[A-Z]/g);\r\n\r\n                // store the old cells, " +
"if necessary, to support the back button:\r\n                var storeOldValues = " +
"false;\r\n                if (!step.OldRowValues) {\r\n                    step.OldR" +
"owValues = [];\r\n                    storeOldValues = true;\r\n                }\r\n " +
"               \r\n                // now iterate along the clue axis and update t" +
"he letter\r\n                for (var offset = 0; offset < cells.length; offset++)" +
" {\r\n                    var qr = axisIdxOffsetToQR(step.InspectedAxis, step.Insp" +
"ectedIdx, offset);\r\n                    var cell = hexDataByQR[qr.q][qr.r];\r\n\r\n " +
"                   var oldVal = cell.text();\r\n                    var newVal = c" +
"ells[offset];\r\n\r\n                    if (storeOldValues) {\r\n                    " +
"    step.OldRowValues[offset] = oldVal;\r\n                    }\r\n\r\n              " +
"      if (oldVal !== newVal) {\r\n                        console.log(\"Cell q = \" " +
"+ qr.q + \", r = \" + qr.r + \" changed from \'\" +\r\n                            oldV" +
"al + \"\' to \'\" + newVal + \"\'\");\r\n\r\n                        cell.text(newVal);\r\n  " +
"                      cell.quickfit();\r\n                    }\r\n                }" +
"\r\n            }\r\n\r\n            function revertStep(step) {\r\n                for " +
"(var offset = 0; offset < step.OldRowValues.length; offset++) {\r\n               " +
"     var qr = axisIdxOffsetToQR(step.InspectedAxis, step.InspectedIdx, offset);\r" +
"\n                    var cell = hexDataByQR[qr.q][qr.r];\r\n                    va" +
"r newVal = step.OldRowValues[offset];\r\n                    if (cell.text() !== n" +
"ewVal) {\r\n                        cell.text(newVal);\r\n                        ce" +
"ll.quickfit();\r\n                    }\r\n                }\r\n            }\r\n\r\n     " +
"       // The following code sets up the UI\r\n            $(function () {\r\n      " +
"          var container = $(\'#container\');\r\n                var canvas = documen" +
"t.getElementById(\"canvas\").getContext(\'2d\');\r\n                $.each(hexDataByQR" +
", function (q, rs) {\r\n                    q = q - 0;\r\n                    $.each" +
"(rs, function (r, val) {\r\n                        r = r - 0;\r\n                  " +
...
" top: xy.y - div.height() / 2, left: xy.x - div.width() / 2 });\r\n               " +
"         hexDataByQR[q][r] = div;\r\n\r\n                        canvas.beginPath();" +
"\r\n                        canvas.moveTo(xy.x + hexCornerOffsets[0].x, xy.y + hex" +
"CornerOffsets[0].y);\r\n                        for (var i = 1; i <= 6; i++) {\r\n  " +
"                          canvas.lineTo(xy.x + hexCornerOffsets[i].x, xy.y + hex" +
"CornerOffsets[i].y);\r\n                        }\r\n                        canvas." +
"stroke();\r\n                    });\r\n                });\r\n                $.each(" +
"cluesByAxisIdx, function (axis, cluesByIdx) {\r\n                    $.each(cluesB" +
"yIdx, function (idx, clue) {\r\n                        idx = idx - 0;\r\n          " +
"              var div = $(\"<div />\")\r\n                            .addClass(\"clu" +
"e\")\r\n                            .addClass(axis)\r\n                            .a" +
"ppend($(\'<span />\').text(clue))\r\n                        container.append(div);\r" +
"\n\r\n                        // if axis == x\r\n                        // x,y,z her" +
...
"           div.css({ top: xy.y - div.height() / 2, left: xy.x - div.width() });\r" +
"\n                        cluesByAxisIdx[axis][idx] = div;\r\n                    }" +
");\r\n                });\r\n                \r\n                var xy = hexQRtoPixel" +
"XY(-6, 9);\r\n                var controls = $(\'#controls\');\r\n                cont" +
"rols.css({ top: xy.y, left: xy.x - controls.width() });\r\n\r\n                $(doc" +
"ument).keypress(function(event) {\r\n                    if (event.keyCode == 39) " +
"{\r\n                        event.preventDefault();\r\n                        hist" +
"oryForward();\r\n                    } else if (event.keyCode == 37) {\r\n          " +
"              event.preventDefault();\r\n                        historyBack();\r\n " +
"                   }\r\n                });\r\n            });\r\n        </script>\r\n " +
"   </head>\r\n    <body>\r\n        <div id=\"container\">\r\n            <canvas id=\"ca" +
"nvas\" width=\"1000\" height=\"1000\"></canvas>\r\n            <div id=\"elts\"></div>\r\n " +
"           <div id=\"controls\">\r\n                <button onClick=\"historyBack()\" " +
"title=\"Go one step back\">&#x21E6;</button>\r\n                <button onClick=\"his" +
"toryForward()\" title=\"Go one step forward\">&#x21E8;</button>\r\n            </div>" +
"\r\n        </div>\r\n    </body>\r\n</html>\r\n");
